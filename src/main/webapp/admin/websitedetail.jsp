			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							数据预览 <small> <i class="icon-double-angle-right"></i>
								查看预览数据源 </small> <span class="pull-right inline"><span
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="table-responsive">
										...
										<table data-toggle="table" data-url="./../showWebsite.action?websiteId=1"
