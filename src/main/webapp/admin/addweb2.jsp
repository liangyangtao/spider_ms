...
<div class="step-pane" id="step2">
	...
	<div class="row">
		<div class="news_list col-sm-6">
			...
			<ul class="list-unstyled" id="urlcheckList">
		...
		<div class="bytext col-sm-4">
			...
			<div class="control-group">
				...
				<div class="radio" id="webModelRadio">
					<label> <input name="webModel" type="radio" class="ace"
						checked="checked" value="1" /> <span class="lbl"> 普通模式</span> </label> <label>
						<input name="webModel" type="radio" class="ace" value="2" /> <span
						class="lbl"> js模式</span> </label>
				</div>
			...
			<div class="input-group">
				<input type="text" id="checkListText"
					class="form-control search-query" /> <span class="input-group-btn">
					<button class="btn btn-purple btn-sm" type="button"
						onclick="fillurlcheckList()">
